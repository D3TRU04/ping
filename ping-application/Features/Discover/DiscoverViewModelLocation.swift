//
//  DiscoverViewModel+Location.swift
//  PingNative
//
//  Location management for discover view model
//
...
extension DiscoverViewModel {
    ...
    func initializeUserLocation() async {
        ...
        if let coord = location {
            ...
            print("Could not get location - map will center when location becomes available")
    ...
    func centerOnUserLocation() {
        ...
        print("No valid cached location, requesting fresh location...")
        locationManager.requestWhenInUseAuthorization()
        locationManager.startUpdatingLocation()
    }
