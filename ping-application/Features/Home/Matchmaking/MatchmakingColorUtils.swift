//
//  MatchmakingColorUtils.swift
//  PingNative
//
//  Shared color utilities for matchmaking components
//

import SwiftUI

enum MatchmakingColorUtils {

    static func getSubcategoryGradient(_ name: String) -> [Color] {
    ...
    static func getSubcategoryColors(_ name: String) -> (light: Color, dark: Color) {
        let lowerName = name.lowercased()
