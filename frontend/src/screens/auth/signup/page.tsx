...
//               <Text style={{ color: "#666", fontSize: 20, marginRight: 10 }}>📧</Text>
//               <StyledTextInput
...
//             >
//               <Text style={{ color: "#FFFFFF", fontSize: 24 }}>G</Text>
...
//             >
//               <Text style={{ color: "#FFFFFF", fontSize: 24 }}>f</Text>
    ...
    >
      <StyledView className="flex-1 bg-[#1FC9C3]">
        ...
        >
          ...
          <StyledView className="flex-row items-center my-5">
            <StyledView className="flex-1 h-[1px] bg-white/30" />
            <AppText className="text-white mx-2.5 opacity-80">OR</AppText>
            <StyledView className="flex-1 h-[1px] bg-white/30" />
          </StyledView>
          ...
          <StyledView className="space-y-4">
            ...
            >
              ...
              <AppText className="text-white text-base font-bold ml-2.5">Continue with Google</AppText>
            </StyledTouchableOpacity>
            ...
            >
              ...
              <AppText className="text-white text-base font-bold ml-2.5">Continue with Facebook</AppText>
            </StyledTouchableOpacity>
          </StyledView>

          <StyledView className="flex-row justify-center mt-8">
            <AppText className="text-white text-sm">Already have an account? </AppText>
            <StyledTouchableOpacity onPress={() => navigation.navigate('SignIn')}>
              <AppText className="text-white text-sm font-bold underline">Sign in</AppText>
            </StyledTouchableOpacity>
          </StyledView>
        </StyledScrollView>
      </StyledView>
